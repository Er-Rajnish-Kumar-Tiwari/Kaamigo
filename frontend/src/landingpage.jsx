...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-purple-100 text-gray-800 text-sm sm:text-base">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-purple-400 via-purple-200 to-orange-200 py-8 sm:py-12 text-center px-4 sm:px-6 md:px-12">
        <motion.h1
          className="font-Montserrat text-center text-[1.8rem] sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-6 px-2 sm:px-4 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-orange-600 to-orange-500 w-full inline-block"
          variants={container}
          initial="hidden"
          animate="visible"
        >
        ...
        <div className="text-lg md:text-xl text-gray-800 max-w-5xl mx-auto text-center leading-relaxed font-medium space-y-6">
          <p>
            <span className="font-semibold text-purple-700">Kaamigo</span> is
            India’s
            ...
            freelance platform tailored for the real
            <span className="italic text-purple-800"> Bharat</span>. We empower
            local talent by bridging gaps with technology that speaks the
            language of every corner of India- from busy towns to emerging Tier
            2 cities.
          </p>
        </div>
        <div className="max-w-3xl mx-auto text-center mb-8">
          <span className="font-semibold text-purple-700 max-w-xl">
            Need an <span className="font-semibold">electrician</span>,{" "}
            <span className="font-semibold">mehendi artist, engineer</span>, or{" "}
            <span className="font-semibold">tutor</span>?{" "}
            <span className="text-purple-700 font-semibold">Kaamigo</span>{" "}
            connects you to skilled local talent through{" "}
            <span className="text-purple-700">reels</span>,{" "}
            <span className="text-purple-700">voice search</span>, and a{" "}
            <span className="text-purple-700">live map</span>.
            <br />
            No red tape- just{" "}
            <span className="text-orange-500 font-semibold">
              real skills
            </span>,{" "}
            <span className="text-orange-500 font-semibold">instant gigs</span>,
            and trusted{" "}
            <span className="text-purple-800 font-medium">conversations</span>.
          </span>
        </div>
      ...
      <section className="py-18 px-6 bg-gradient-to-br from-orange-200 to-purple-300">
        <h2 className="text-4xl text-center mb-14 text-black">
          ...
          <span className="text-purple-600">Top Reels</span>
        </h2>

        <div className="overflow-x-auto">
          <div className="flex justify-center gap-6 px-4 py-2 w-max min-w-full">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="min-w-[200px] bg-white border border-orange-300 rounded-xl shadow-md hover:shadow-2xl hover:-translate-y-1 hover:scale-105 transition-all duration-300 ease-in-out p-5 cursor-pointer"
              >
      ...
      <section className="py-16 px-6 bg-purple-200 overflow-hidden">
        <h2 className="text-4xl text-center mb-12">What Our Users Say</h2>
            ...
            {[1, 2, 3, 4, 1, 2, 3, 4].map((i, index) => (
              ...
              >
                <p className="text-sm italic text-gray-700 mb-4">
                  "Kaamigo made it easier for me to find work without the
                  stress!"
                </p>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 md:gap-16">
          ...
          <div className="md:w-2/3 text-center md:text-left">
            <h2 className="text-4xl font-bold mb-4 text-purple-800 leading-snug">
              Get the <span className="text-orange-600">Kaamigo</span> App
              Today!
            </h2>
            <p className="text-lg text-gray-800 mb-8 max-w-xl">
              Experience{" "}
              <span className="font-semibold text-purple-600">
                voice-first freelancing
              </span>{" "}
              on the go. Download the app to connect, collaborate, and get hired
              — anytime, anywhere.
            </p>
