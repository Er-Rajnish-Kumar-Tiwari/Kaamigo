...
export default function LoginPage() {
  ...
  return (
    <div className="max-h-screen flex items-center justify-center bg-[#f3f3fc] px-4">
      <div className="mt-8 max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="p-10">
          ...
          <p className="text-sm text-center mt-6 text-gray-500">
            New user?{" "}
            <a onClick={()=>navigate("/sign")} className="text-blue-600 font-medium underline cursor-pointer">
              Register here
            </a>
          </p>
        </div>

        <div className="bg-gradient-to-t from-pink-400 to-purple-500 flex items-center justify-center px-8 py-10 text-center">
          <div>
