    ...
    <div className="bg-purple-200 text-gray-800">
      ...
      <section className="text-center py-10 px-4 bg-gradient-to-r from-purple-300 to-orange-300">
        ...
        <p className="max-w-3xl mx-auto text-lg">
          To empower everyday individuals across India by making social
          freelance opportunities accessible, trusted, and voice-driven -
          bridging skill with demand through reels, real-time discovery, and
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 gap-8 px-6 py-12 max-w-5xl mx-auto">
        <div className="bg-white shadow-lg p-6 rounded-xl text-center border border-purple-100">
          ...
          <p>
            We strive to connect freelancers and businesses through voice-first,
            reel-based storytelling, making work accessible to Tier 2/3 India.
          </p>
        </div>
        <div className="bg-white shadow-lg p-6 rounded-xl text-center border border-orange-100">
          ...
          <p>
            To be India’s most trusted freelance ecosystem focused on
            inclusivity, opportunity, and innovation.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h4 className="text-xl font-semibold text-orange-500 mb-2">
              Voice + Video Discovery
            </h4>
            <p>
              We make it easy to find and hire freelancers using reels, voice
              search, and maps- no typing required.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h4 className="text-xl font-semibold text-orange-500 mb-2">
            ...
            <p>
              Low-data design and multilingual support make Kaamigo perfect for
              Tier 2/3 cities and rural India.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h4 className="text-xl font-semibold text-orange-500 mb-2">
            ...
            <p>
              Freelancer reels, ratings, and reviews create visibility, proof of
              skill, and real-time connections.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h4 className="text-xl font-semibold text-orange-500 mb-2">
            ...
            <p>
              Anyone can join and start working—no certification or middleman
              needed.
            </p>
          </div>
        </div>
      ...
      <section className="px-6 py-12 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            ...
            <p className="text-md">
              A team of dreamers from Bharat creating voice-first tech for
              employment.
            </p>
          </div>
          <div>
            ...
            <p className="text-md">
              By matching people with opportunities via short reels and voice.
            </p>
          </div>
          <div>
            <h4 className="font-bold text-2xl text-orange-500 mb-2">
            ...
            <p className="text-md">
              Bridge the skill-access gap with trust, simplicity, and community.
            </p>
          </div>
          <div>
            <h4 className="font-bold text-2xl text-orange-500 mb-2">
            ...
            <p className="text-md">
              We believe talent exists everywhere - it just needs a chance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 px-6 bg-gradient-to-r from-purple-200 to-orange-100">
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <a href="mailto:info@kaamigo.com">
