...
const tasks = [
  ...
  },
  {
    ...
    coins: 80,
    icon: (
      <FaRobot className="text-4xl text-orange-500 mx-auto mb-2" title="AI" />
    ),
  },
  {
  ...
  },
  {
    ...
    coins: 20,
    icon: (
      <FaLink className="text-4xl text-blue-500 mx-auto mb-2" title="Share" />
    ),
  },
  {
...
const transactions = [
  {
    desc: "Completed Daily Quiz",
    date: "2024-07-01",
    amount: "+15",
    type: "pos",
  },
  {
    desc: "Purchased Premium Article Access",
    date: "2024-06-28",
    amount: "-120",
    type: "neg",
  },
  {
    desc: "Finished 'Introduction to React'",
    date: "2024-06-27",
    amount: "+80",
    type: "pos",
  },
  {
    desc: "Logged in daily bonus",
    date: "2024-06-27",
    amount: "+10",
    type: "pos",
  },
  {
    desc: "Unlocked Advanced Algorithms course",
    date: "2024-06-26",
    amount: "-250",
    type: "neg",
  },
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8">
          <div className="flex-1 flex flex-col sm:flex-row items-center bg-gradient-to-r from-purple-200 via-white to-orange-200 rounded-2xl shadow-xl p-6 md:p-8 border border-purple-100 gap-4">
            <div className="text-6xl text-orange-400">
              <FaCoins title="Your Coins" />
            </div>
            <div className="text-center sm:text-left">
              <div className="text-5xl font-extrabold text-purple-700 mb-1 drop-shadow">
                1573
              </div>
            ...
            <ul className="space-y-2">
              {transactions.map((t, i) => (
                ...
                >
                  ...
                  <div
                    className={
                      t.type === "pos" ? "text-green-600" : "text-red-600"
                    }
                  >
                    {t.amount}
                  </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="flex-1">
            <h2 className="text-3xl font-extrabold mb-6 text-purple-700">
              Tasks to Earn More Coins
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
              {tasks.map((task, i) => (
                <div
                  key={i}
                  className="bg-white rounded-2xl shadow-xl p-4 flex flex-col justify-between border-2 border-purple-100 hover:border-orange-300 hover:shadow-2xl transition-all duration-300"
                >
                  <div>
                    {task.icon ? (
                    ...
                    <div className="font-bold text-purple-700 mb-1 text-lg">
                      {task.title}
                    </div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <button className="bg-gradient-to-r from-purple-500 to-orange-400 text-white px-4 py-2 rounded-lg shadow hover:scale-105 transition font-semibold">
                      Start Task
                    </button>
                  </div>
                </div>
