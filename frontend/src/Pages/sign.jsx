...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 to-orange-100 px-4">
      <div className="mt-4 mb-4 max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 bg-white rounded-2xl shadow-lg overflow-hidden">
        <div className="bg-gradient-to-bl from-purple-400 to-pink-500 text-white flex flex-col justify-center items-center p-10">
        ...
        <div className="p-10 flex flex-col justify-center">
          <p className="text-sm text-right text-gray-600 mb-4">
            ...
            <a onClick={()=>navigate("/login")} className="text-blue-600 font-medium underline cursor-pointer">Log in</a>
          </p>
