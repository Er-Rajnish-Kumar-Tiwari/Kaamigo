      ...
      <footer className="bg-[#181B23] py-6 px-6 text-gray-300 text-center md:text-left animate-fade-in">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-2 text-sm md:items-center">
            ...
            <a onClick={()=>navigate("/explore")} className="hover:text-purple-400 transition cursor-pointer">Explore</a>
            <a onClick={()=>navigate("/partners")} className="hover:text-purple-400 transition cursor-pointer">Partners</a>
