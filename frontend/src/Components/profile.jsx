  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-purple-50 to-orange-100 font-inter">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r shadow-xl p-6 space-y-6 rounded-r-xl">
        <h2
          className="text-2xl font-extrabold text-purple-700 cursor-pointer"
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md space-y-4">
              ...
              <p className="text-gray-700 text-sm">
                Hi, I’m Sarah, a passionate graphic designer proficient in
                Figma, Adobe Suite, and Sketch. I’m bilingual (English &
                Mandarin) with 7 years of experience in branding, UI/UX design,
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={svc}
                    className="border p-5 rounded-lg text-center hover:shadow-lg transition"
                  >
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div
                    key={i}
                    className="bg-gray-100 h-32 rounded-lg flex items-center justify-center text-sm text-gray-500"
                  >
                    Project {i + 1}
                  </div>
                ))}
